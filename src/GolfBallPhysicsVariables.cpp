...
{
    Re100 = rhoMetric * 44.7 * (ball.std_golf_ball_circumference / (M_PI * 39.37)) * (math_utils::convertCelsiusToKelvin(tempC) + 120) / (0.000001512 * std::pow(math_utils::convertCelsiusToKelvin(tempC), 1.5));
}